...
function HowItWorksStep({ number, title, description, icon }: HowItWorksStepProps) {
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className="transition-all duration-300 transform flex flex-col h-full relative overflow-hidden group bg-card border-border">
        <div className="absolute top-0 left-0 w-32 h-32 opacity-5 transform -translate-x-1/4 -translate-y-1/4 transition-transform group-hover:translate-x-0 group-hover:translate-y-0 duration-300 text-muted-foreground">
